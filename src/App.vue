      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item
            ...
            text="white"
            to="/Login"
            >Inicia sesión</b-nav-item
          >
          <b-nav-item variant="primary" v-if="loggedIn" text="white" to="/List"
            >Lista de Actividades</b-nav-item
          >
          <b-nav-item
            variant="primary"
            v-if="loggedIn"
            text="white"
            to="/Calendar"
            >Calendario de Actividades</b-nav-item
          >
          <b-nav-item variant="primary" v-if="loggedIn" text="white" to="/Timer"
            >Temporizador</b-nav-item
          >
          <b-nav-item
            variant="primary"
            v-if="loggedIn"
...
export default {
  ...
  computed: {
    ...
    username() {
      //obtencion del usuario para el dropdown de usuario
